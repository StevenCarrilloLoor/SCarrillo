...
namespace SCarrillo.Controllers
{
    public class CarrerasController : Controller
    {
        ...
        public CarrerasController(SCarrilloContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CarreraId,NombreCarrera,Campus,NumeroSemestres")] Carrera carrera)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CarreraId,NombreCarrera,Campus,NumeroSemestres")] Carrera carrera)
        {
